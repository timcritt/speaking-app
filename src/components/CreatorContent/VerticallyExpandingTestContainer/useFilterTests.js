...
const useFilterTests = (tests, tagFilterTerm, sortBy, questionFilterTerm, setFilteredTests) => {
  ...
  }, [questionFilterTerm, tagFilterTerm, sortBy, params, tests, setFilteredTests]);
};
