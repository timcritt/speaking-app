      ...
      <Fragment>
        ...
        <main className='holy-grail-content centre-vertically'>
          <form className={styles.container}>
            ...
            <legend>Images <ToolTip text={'Images for this part of the test are related by topic, with notable similarities but also differences. They must show people engaged in an activity or interaction'}/></legend>
                  ...
                  {context.imageTwoUrl ? (
                    ...
                    />
                      ...
                      <SimpleModal
                          modalButtonText={'upload'}
                          setImageUrl={context.handleEditImageTwoUrl}
                          modalButton={<button className={`${styles.clickable_image_overlay} ${styles.image_container} ${inputStatus.imageTwoFailedValidation && styles.required_input_incomplete} `}></button>}
                  />)
                  }
                </ExamPicture>
              </div>
            ...
            <legend>Questions</legend>
              <label>long turn <ToolTip text={'The long turn question asks one candidate to speculate for 1 minute about the photos, e.g, the intentions of the people pictured, the challenges involved, etc.'}/></label>
              <input
                label='long-turn'
              ...
              />
              <label>short turn<ToolTip text={'The short turn question asks the other candidate to answer a personal question related to the topic of the pictures'}/></label>
              <input
                label='short-turn'
            ...
            <fieldset>
              <legend>Topic Tags <ToolTip text={'Add at least one tag to help you and others search for your test according to topic'}/></legend>
              <div className={`${styles.tags_container} ${inputStatus.topicTagsFailedValidation && styles.required_input_incomplete}`}>
                <SideBarTags
